...
F 1 "470R" H 3305 2020 50  0000 R CNN
...
F 1 "470R" H 6905 2020 50  0000 R CNN
...
F 1 "470R" H 10230 2120 50  0000 R CNN
...
U 1 1 5FF151DF
P 1350 1400
F 0 "R12" V 1143 1400 50  0000 C CNN
...
U 1 1 5FF151E5
P 1650 1625
F 0 "C4" H 1765 1671 50  0000 L CNN
...
F 1 "470R" H 10205 4870 50  0000 R CNN
...
U 1 1 5FF15225
P 1925 1400
F 0 "R14" V 2132 1400 50  0000 C CNN
...
F 1 "560R" H 1555 6520 50  0000 R CNN
...
U 2 1 600D1945
P 9550 1600
F 0 "U1" H 9550 1967 50  0000 C CNN
...
U 1 1 600DA883
P 6225 1500
F 0 "U2" H 6225 1867 50  0000 C CNN
...
Wire Wire Line
	2850 3725 2950 3725
$Comp
L reprapltd-kicad:Arduino_Mega2560_Shield XA1
U 1 1 5FFE7D96
P 4500 5025
F 0 "XA1" V 4447 7353 60  0000 L CNN
F 1 "Arduino_Mega2560_Shield" V 4553 7353 60  0000 L CNN
F 2 "reprapltd-kicad:Arduino_Mega2560_Shield" H 5200 7775 60  0001 C CNN
...
PWMin3
Text GLabel 5650 6525 3    50   Input ~ 0
PWMin2
Text GLabel 5750 6525 3    50   Input ~ 0
PWMin1
Text GLabel 5850 6525 3    50   Input ~ 0
PWMin0
...
U 1 1 5FD8EFBA
P 8250 4250
F 0 "R1" V 8043 4250 50  0000 C CNN
...
U 1 1 5FD8F543
P 8550 4475
F 0 "C1" H 8665 4521 50  0000 L CNN
...
U 1 1 5FDA4DE9
P 8825 4250
F 0 "R2" V 9032 4250 50  0000 C CNN
...
Text Notes 3500 675  0    50   ~ 0
Maybe make 120K 100K on op amp input.
$EndSCHEMATC
